...
//             $sql = "SELECT pt.item_name, sdt.weight, sdt.melt, sdt.rate, sdt.bhaw, sdt.amount, sdt.lab_charge, sdt.making_charge, sdt.other_charge, sdt.gst, sdt.grand_total FROM saledetail_tbl AS sdt JOIN product_tbl as pt ON pt.product_id=sdt.product_id WHERE sdt.sid=" . $row['sid'];
