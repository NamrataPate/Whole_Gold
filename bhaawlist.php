...
<script>
$(function(){
   $(document).attr("title", "BHAAW DATA");
});
</script>

<div class="card border-bottom-0 mb-0">
	<div class="card-header">
    	<strong>Bhaaw Data List</strong>
  	</div>
            ...
            <div class="row">
              <div class="col-sm-3">
                  ...
                  <div class="input-daterange input-group input-group-sm" id="datepicker">
                      <input type="text" class="form-control form-control-sm mb-2" name="from_date" id="from_date" autocomplete="off" required="" value="">
                      <div class="input-group-prepend">
                        <span class="input-group-text mb-2" id="inputGroup-sizing-sm">to</span>
                      </div>
                      <input type="text" class="form-control form-control-sm mb-2" name="to_date" id="to_date" autocomplete="off" required="" value="">
                  </div>
              </div>
              <div class="col-sm-2">
